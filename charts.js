...
// 1. Create the buildCharts function.
  ...
  // 2. Use d3.json to load and retrieve the samples.json file 
    ...
    // 10. Use Plotly to plot the data with the layout: Using plotly.newPlot() function.
...
// Delivarable 2
    ...
    // 2. Create the layout for the bubble chart. Add a title, a label for the x-axis, margins, and the hovermode property.
...
// 2. Create a variable that holds the first sample in the array. Note: Step 1 & 2 are combined in one line.
